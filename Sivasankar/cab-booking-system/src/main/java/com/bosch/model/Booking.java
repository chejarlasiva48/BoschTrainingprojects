...
public class Booking {
	...
	private Long userId;
	@NotNull(message = "DriverId not be Null")
	private Long driverId;
	@NotNull(message = "PickUpLocation cann't ne null")
	@NotBlank(message = "PickUpLocation cann't ne blank")
	private String pickUpLocation;
	@NotNull(message = "DropOffLocation cann't ne null")
	@NotBlank(message = "DropOffLocation cann't ne blank")
